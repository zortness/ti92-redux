...
keyboard.keymap = [
    [ # Layer 0
        ...
        KC_PWR,  DIA_EN,   SEC_EN,   KC.TAB,  KC.SPC,  ______,   KC.EQL,  KC.BSPC, ______,   ______,
    ],
    [ # Layer 1 (mouse)
    ...
    [ # Layer 2 (2nd)
        ______,  MOUSE_EN, SEC_EN,   KC.ESC,  KC.UP,   KC.RIGHT, KC.LCBR, KC.RCBR, KC.LBRC,  KC.RBRC,
    ...
    [ # Layer 3 (<>)
        ...
        KC.A,    KC.S,     KC.D,     KC.F,    KC.G,    KC.H,     KC.J,    KC.K,    KC.L,     ______,
        KC.LSFT, KC.Z,     KC.X,     KC.C,    KC.V,    KC.B,     KC.N,    KC.M,    KC_THTA,  KC.ENT,
        KC_PWR,  DIA_EN,   SEC_EN,   KC.TAB,  KC.SPC,  ______,   KC.EQL,  KC.DEL,  ______,   ______,
    ]
]
